...
SIZE_MAP = [
    ...
    ("72b", ("Qwen-72B", 72)),
    ("haiku", ("Haiku", 40)), ("sonnet", ("Sonnet", 600)), ("opus", ("Opus", 4000)),
    ...
    # flash-lite key before flash.
    ("gemini-2.5-flash-lite", ("Gemini-2.5-flash-lite", 4)),
    ("gemini-2.5-flash", ("Gemini-2.5-flash", 31)), ("gemini-2.5-pro", ("Gemini-2.5-pro", 288)),
]
...
def main():
    ...
    for metric in METRICS:
        ...
        ax.set_xlabel("model size (B, log; Gemini=real est., Claude/GPT=ordinal placeholders)")
